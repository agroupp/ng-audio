module.exports = {
  types: [
    ...
    {
      value: 'ci',
      name: '💨  - CONTINUOUS INTEGRATION: changes that affect either the build or deployment process'
    },
    {
      value: 'test',
  ...
  scopes: [{ name: 'workspace' }, { name: 'core' }, { name: 'visualization' }, { name: 'shared' }, { name: 'utils' }, { name: 'demo' }],
  messages: {
